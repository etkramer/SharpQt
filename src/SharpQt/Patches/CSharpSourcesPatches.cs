...
static class CSharpSourcesPatches
{
    ...
    static bool GenerateClassInternalsFieldsPrefix(
        CSharpSources __instance,
        Class @class,
        bool sequentialLayout
    )
    {
        return false;
    }
    ...
    static void GetClassInternalHeadPostfix(ref string __result)
    {
    ...
    static bool GenerateClassSpecifierPrefix(CSharpSources __instance, Class @class)
    {
